				...
				function SK_pbSekindo_84373598ad9c20d8bd_firePix(src)
				{
				...
				function SK_pbSekindo_84373598ad9c20d8bd_verificationCode()
				{
					...
					if (verificationCodeData != null)
					{
						for(var i in verificationCodeData)
						{
							if(verificationCodeData.hasOwnProperty(i))
							{
								...
								{
									SK_pbSekindo_84373598ad9c20d8bd_firePix(verificationCodeData[i]);
								}
							}
						}
					}
				...
				try
				{
					window.pbjs.sekindoCB('28cac701b3ec089', HB_bid);
				}
				catch(e){}
