				...
				function SK_pbSekindo_84374598ad9c16ae91_firePix(src)
				{
				...
				function SK_pbSekindo_84374598ad9c16ae91_verificationCode()
				{
					...
					if (verificationCodeData != null)
					{
						for(var i in verificationCodeData)
						{
							if(verificationCodeData.hasOwnProperty(i))
							{
								...
								{
									SK_pbSekindo_84374598ad9c16ae91_firePix(verificationCodeData[i]);
								}
							}
						}
					}
				...
				try
				{
					window.pbjs.sekindoCB('29ac02ad387db1a', HB_bid);
				}
				catch(e){}
