				...
				function SK_pbSekindo_84372598ad9bea172b_firePix(src)
				{
				...
				function SK_pbSekindo_84372598ad9bea172b_verificationCode()
				{
					...
					if (verificationCodeData != null)
					{
						for(var i in verificationCodeData)
						{
							if(verificationCodeData.hasOwnProperty(i))
							{
								...
								{
									SK_pbSekindo_84372598ad9bea172b_firePix(verificationCodeData[i]);
								}
							}
						}
					}
				...
				try
				{
					window.pbjs.sekindoCB('336695bfec907d2', HB_bid);
				}
				catch(e){}
